...
class BomEngine{
  ...
  exportModel(){return {schema:'scaffr200-project-model-2',version:'9.5',exportedAt:new Date().toISOString(),components:this.catalog.exportData(),bom:this.toQuantityObject(),ledger:this.toLedgerObject(),instances:this.instances}}
}
